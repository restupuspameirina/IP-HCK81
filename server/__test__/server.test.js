...
describe('POST /books', () => {
    test('should be success insert book', async () => {
        const newBook = {
            ...
            "price": 35000,
            "imgUrl": "https://gratefulamericanfoundation.org/wp-content/uploads/2025/01/Kate-Chopin-THE-AWAKENING-1.jpg",
            "stock": 10,
            "GenreId": 1
        }
...
describe('PUT /books/:id', () => {
    ...
    test('should fail book not found', async () => {
        ...
        const response = await request(app).put('/books/100')
            .set('Authorization', `Bearer ${access_token_user}`)
            .send(newBook);
...
describe('DELETE /books/:id', () => {
    test('should fail book not found', async () => {
        ...
        expect(response.status).toBe(200);
        expect(response.body.message).toEqual("The Literary Awakening 2 success deleted");
    })
    ...
    test('should fail menu not found', async () => {
